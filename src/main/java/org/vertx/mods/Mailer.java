 ...
 *
 * Modified to support multipart messaging by Michael Stephenson for Intergral GmbH 2014
 *
 ...
 * @author Michael Stephenson for Intergral GmbH
 */
public class Mailer extends BusModBase implements Handler<Message<JsonObject>>
{
    ...
    public void start()
    {
        ...
        if( !fake )
        {
            ...
            catch( MessagingException e )
            {
                ...
                {
                    logger.error( "Failed to setup mail transport" );
                }
            }
        }
    }
    ...
    private InternetAddress[] parseAddresses( Message<JsonObject> message, String fieldName, boolean required )
    {
    ...
    public void handle( Message<JsonObject> message )
    {
        ...
        String html = message.body().getString( "html" );
        ...
        try
        {
            ...
            plainTextPart.setText(body, "utf-8");
            if (html != null)
            {
